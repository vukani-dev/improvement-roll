      ...
      <Kitten.Modal
        ...
        <Kitten.Layout style={styleSheet.modal_container}>
          ...
          <Kitten.Layout
            ...
            <Kitten.Button onPress={() => setResetModalVisible(false)}>
              No
            </Kitten.Button>
          ...
          <Kitten.Modal
            ...
            <Kitten.Layout style={styleSheet.modal_container}>
              ...
              <Kitten.Layout
                ...
                <Kitten.Button onPress={() => setDebugModalVisible(false)}>
                  No
                </Kitten.Button>
                <Kitten.Button
  ...
  return (
    <Kitten.Layout style={styleSheet.options_container}>
      ...
      <Kitten.Layout
        ...
        <Kitten.Button onPress={() => openGithub()} accessoryRight={OctoIcon}>
